...
A partir de esto, la investigación se centra en medir fisicamente los bolsillos  de 80 pantalones de 20 marcas distintas para comprobar si realmente existe una desigualdad funcional.
 ...
 Otro aspecto destacable son los graficos como se puede interactuar con ellos. En lugar de limitarse a solo cifras, presenta graficos para ejemplificar las cifras. Esto no solo mejora la claridad de la información, sino también fortalece el impacto comunicativo. Además, me llamó la atención la sección donde vemos los objetos que caben en un pantalón femenino y la comparación con el masculino, considerando si es skinny jeans y rectos.

 Finalmente lo más significante a mi parecer es la gran base de datos que presentan, la base la filtran por marcas y precios, ademas de incluir la foto del bolsillo y las medidas de cada pantalón, tanto para pantalones femeninos y masculinos. De igual manera, destaco profundamente los graficos para ejemplificar las cifras y que estos sean interactivos, hace que la experiencia sea mucho más completa y visual. Además, facilita la comprensión de la problematica al mostrarla graficamente. 

 ## Efectividad de transmisión de información

  La webstory de The Pudding logra una transmisión de información altamente efectiva al combinar datos con visualizaciones interactivas que facilitan la comprensión inmediata. En lugar de depender de explicaciones extensas, utiliza elementos visuales claros que permiten al usuario entender el problema de forma intuitiva. La interacción refuerza el aprendizaje, ya que transforma al lector en participante activo. Además, el uso del scroll organiza la información de manera progresiva, evitando la sobrecarga. Aunque la problematica es cotidiana y no tratada, el trabajo de esta es clara,  el atractiva visualmente y la experiencia inmersiva convierten la historia en un ejemplo exitoso de comunicación de datos.
